...
func (_m *MockOption) Execute(_a0 *Store) {
	_m.Called(_a0)
}
...
func (_c *MockOption_Execute_Call) Run(run func(_a0 *Store)) *MockOption_Execute_Call {
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*Store)) *MockOption_Execute_Call {
	_c.Call.Return(run)
	return _c
}
